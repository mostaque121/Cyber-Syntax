...
import ReceiptConnect from "@/components/documents/receipt/receipt-connect";
...
export default function ReceiptPreview({
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: receipt.receiptNumber ?? "Invoice",
    pageStyle: `
    @page {
      size: A4;
      margin: 12mm 0;
        ...
        <div className="min-h-screen overflow-y-auto bg-gray-100">
          <div className="flex bg-gray-400 justify-center">
            <div className="py-8 bg-white">
              <div ref={receiptRef}>
                <ReceiptConnect orderId={orderId} receipt={receipt} />
              </div>
            </div>
          </div>
