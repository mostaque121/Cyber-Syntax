...
export function NewCategoryInput({
  ...
  return (
    <div
      className={`flex flex-col md:flex-row md:items-center gap-2 py-2 px-3 ${
        isRoot ? "border-2 border-dashed border-border rounded-lg" : "ml-6" // Using padding for child input
      }`}
      style={{ marginLeft: marginLeft }}
    >
      <div className="flex items-center gap-2 flex-1 w-full">
        <div className="h-4 w-4 rounded-full bg-primary/20 border-2 border-primary/40 shrink-0" />
        <Input
      ...
      <div className="flex  items-center gap-2 flex-1 w-full md:ml-0 ml-6">
        <SlugInput
      ...
      <div className="flex items-center gap-2 md:ml-0 ml-6">
        <Button
          size="sm"
          variant="ghost"
