...
interface SectionProps {
  images: CctvPackageImage[];
}

export function CctvPackageImages({ images }: SectionProps) {
  const [selectedImage, setSelectedImage] = useState<CctvPackageImage>(
