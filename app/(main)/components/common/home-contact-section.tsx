          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              ...
              >
                ...
                <Card className="sm:hidden bg-white border border-primary p-4 gap-0 rounded-[5px] hover:shadow-lg transition-all h-full flex flex-row items-center">
                ...
                <Card className="hidden sm:block bg-white border border-primary p-4 gap-0 rounded-[5px] hover:shadow-lg transition-all h-full text-center">
